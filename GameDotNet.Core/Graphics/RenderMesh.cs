...
public class DisposableBuffer : IDisposable
{
    ...
    public DisposableBuffer(VulkanMemoryAllocator allocator, in BufferCreateInfo buffInfo,
    ...
    public DisposableBuffer(VulkanMemoryAllocator allocator, Buffer buffer, Allocation allocation)
    {
        _allocator = allocator;
        Buffer = buffer;
    ...
    public static implicit operator Buffer(DisposableBuffer buff) => buff.Buffer;
