...
public static partial class ServiceCollectionExtensions
{
    ...
    [GenerateServiceRegistrations(CustomHandler = nameof(AddView), AssignableTo = typeof(ReactiveUserControl<>))]
    private static partial IServiceCollection AddReactiveUserControls(this IServiceCollection services);
    
    [GenerateServiceRegistrations(CustomHandler = nameof(AddView), AssignableTo = typeof(ReactiveWindow<>))]
