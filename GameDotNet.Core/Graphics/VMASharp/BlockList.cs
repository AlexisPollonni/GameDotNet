    ...
    internal class BlockList : IDisposable
    {
        ...
        public bool IsBufferImageGranularityConflictPossible()
        {
            ...
            foreach (var block in blocks)
            {
                ...
                if (metadata.IsBufferImageGranularityConflictPossible(this.BufferImageGranularity,
                                        ...
                                        SuballocationType suballocType)
        {
            ...
            bool canCreateNewBlock = ((createInfo.Flags & AllocationCreateFlags.NeverAllocate) == 0) &&
                                     (this.blocks.Count < this.maxBlockCount) &&
            ...
            if (canCreateNewBlock)
            {
                ...
                var res = (newBlockSize <= freeMemory || !canFallbackToDedicated)
                              ? this.CreateBlock(newBlockSize, out newBlockIndex)
            ...
            if (canMakeOtherLost)
            {
                ...
                for (; tryIndex < AllocationTryCount; ++tryIndex)
                {
                    ...
                    if (bestRequestBlock != null)
                    {
                        ...
                        if (bestRequestBlock.MetaData.MakeRequestedAllocationsLost(currentFrame, this.FrameInUseCount,
                                ref bestAllocRequest))
                        {
                            ...
                            this.Allocator.Budget
                                .AddAllocation(this.Allocator.MemoryTypeIndexToHeapIndex(this.MemoryTypeIndex), size);
                                              ...
                                              AllocationCreateFlags flags, object? userData)
        {
            ...
            if (block.MetaData.TryCreateAllocationRequest(in context, out var request))
            {
                ...
                allocation.InitBlockAllocation(block, request.Offset, context.AllocationAlignment,
                                               context.AllocationSize, this.MemoryTypeIndex,
                ...
                this.Allocator.Budget.AddAllocation(this.Allocator.MemoryTypeIndexToHeapIndex(this.MemoryTypeIndex),
        ...
        private unsafe Result CreateBlock(long blockSize, out int newBlockIndex)
        {
            ...
            MemoryAllocateFlagsInfoKHR allocFlagsInfo =
            ...
            var block = new VulkanMemoryBlock(this.Allocator, this.ParentPool, this.MemoryTypeIndex, mem,
                                              this.nextBlockID++, metaObject);
