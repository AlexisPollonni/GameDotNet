...
public interface IVulkanAllocCallback : IVulkanWrapper<AllocationCallbacks>
{
    public new ref readonly AllocationCallbacks Underlying { get; }

    protected unsafe void* Allocate(
        object? userData,
        nuint size,
        nuint alignment,
    ...
    protected unsafe void* Reallocate(
        object? userData,
        void* pOriginal,
        nuint size,
        nuint alignment,
    ...
    protected void InternalAllocNotification(
        object? userData,
        nuint size,
    ...
    protected void InternalFreeNotification(
        object? userData,
        nuint size,
        InternalAllocationType type,
        SystemAllocationScope scope
...
public abstract class BaseVulkanAllocator : IVulkanAllocCallback
{
    ...
    public ref readonly AllocationCallbacks Underlying => ref _callbacks;

    private AllocationCallbacks _callbacks;

    protected BaseVulkanAllocator(IVulkanContext ctx, object? userData)
    {
    ...
    public abstract unsafe void* Allocate(
        object? userData,
        nuint size,
        nuint alignment,
        SystemAllocationScope scope
    ...
    public abstract unsafe void* Reallocate(
        object? userData,
        void* pOriginal,
        nuint size,
        nuint alignment,
    ...
    public abstract void InternalAllocNotification(
        object? userData,
        nuint size,
        InternalAllocationType type,
        SystemAllocationScope scope
    ...
    public abstract void InternalFreeNotification(
        object? userData,
        nuint size,
        InternalAllocationType type,
        SystemAllocationScope scope
    ...
    private unsafe AllocationCallbacks ToCallbacks(object? userData)
    {
        return new(
            ...
            new(
                (_, ptr, size, alignment, scope) =>
                    Reallocate(userData, ptr, size, alignment, scope)
            ),
